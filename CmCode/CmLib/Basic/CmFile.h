...
#ifndef MoveFileExA
#define MoveFileExA(x,y,z) cout<<"Error: MoveFileExA not defined"<<endl;
#define DeleteFileA(x) cout<<"Error: DeleteFileA not defined"<<endl;
#define GetFileAttributesA(x) 0
#define GetCurrentDirectoryA(x,y) 0
